...
MySQL - 8.0.40 : Database - dblibrary
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`dblibrary` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
(17,'Avinash',3,'Avinash destory','Ravinder Singh','2025-03-22','Jojo'),
(18,'akshay',2,'akshay','akshay','2025-03-22','akshay'),
(19,'aaa',1,'aaa','aaa','2016-10-10','aaa'),
(20,'12',1,'12','12','2016-10-10','12');
...
(4,'12345673','science','invention of science','unknown','2016-10-10','unknown',6,185,1,'Available','Fiction','Donate',1,0,'Donate'),
...
(22,'12345652','aaa','aaa','aaa','2016-10-10','aaa',1,0,1,'Available','Unknown','000',1,1,'Donate'),
(23,'12345632','12','12','12','2016-10-10','12',1,0,1,'Available','Unknown','000',1,0,'Donate'),
(24,'852741','avinash','destory world','avinash','2016-10-10','avinash',10,0,1,'Available','Fiction','900',1,0,'Donate');
...
CREATE TABLE `tblborrow` (
  ...
  `AccessionNo` varchar(90) NOT NULL,
  `NoCopies` int DEFAULT NULL,
  `DateBorrowed` datetime DEFAULT NULL,
  `Purpose` varchar(90) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `Status` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `DueDate` datetime DEFAULT NULL,
  `BorrowerId` int DEFAULT NULL,
  `Due` tinyint(1) DEFAULT NULL,
  `Remarks` varchar(90) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
(27,'852741',1,'2025-03-22 10:14:57','Research','Returned','2025-03-22 11:30:00',789,NULL,'On Time'),
(28,'123456789',1,'2025-04-02 23:55:21','Overnight','Borrowed','2025-04-03 23:55:21',78965,1,'Overdue'),
(29,'123456789',1,'2025-04-02 23:57:47','Research','Borrowed','2025-04-02 17:30:00',78965,NULL,NULL),
(30,'852741',1,'2025-04-02 23:58:53','Overnight','Returned','2025-04-03 23:58:53',78965,NULL,'On Time'),
(31,'12345671',1,'2025-04-14 09:54:29','Research','Returned','2025-04-14 11:30:00',78965,NULL,'On Time');
...
CREATE TABLE `tblborrower` (
  ...
  `Firstname` varchar(125) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `Lastname` varchar(125) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `MiddleName` varchar(125) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `Address` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `Sex` varchar(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `ContactNo` varchar(125) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `CourseYear` varchar(125) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `BorrowerPhoto` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `BorrowerType` varchar(35) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `Stats` varchar(36) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `IMGBLOB` blob,
  PRIMARY KEY (`IDNO`),
...
(10,'789','789','789','789','789','Male','789','789','','Student','Active',NULL),
(11,'78965','ravi','Singh','test','test','Male','123456789','2025','','Student','Active',NULL);
...
(483,3,'2025-03-22 09:20:55','Logged in'),
(484,3,'2025-03-22 09:23:17','Logged in'),
(485,3,'2025-03-22 09:23:39','Logged in'),
(486,3,'2025-03-22 09:36:29','Logged in'),
(487,3,'2025-03-22 09:41:03','Logged in'),
(488,3,'2025-03-22 09:49:19','Logged in'),
(489,3,'2025-03-22 10:03:31','Logged in'),
(490,3,'2025-03-22 10:06:49','Logged in'),
(491,3,'2025-03-22 10:09:54','Logged in'),
(492,3,'2025-03-22 10:18:34','Logged in'),
(493,3,'2025-03-22 10:19:25','Logged in'),
(494,3,'2025-03-22 10:21:28','Logged in'),
(495,3,'2025-03-22 10:23:33','Logged in'),
(496,3,'2025-03-22 10:24:00','Logged in'),
(497,3,'2025-03-22 10:24:40','Logged in'),
(498,3,'2025-03-22 10:27:13','Logged in'),
(499,3,'2025-03-22 10:28:48','Logged in'),
(500,3,'2025-03-22 10:29:06','Logged out'),
(501,3,'2025-03-24 20:44:52','Logged in'),
(502,3,'2025-03-24 20:45:57','Logged out'),
(503,3,'2025-04-02 22:53:51','Logged in'),
(504,3,'2025-04-02 22:55:46','Logged out'),
(505,3,'2025-04-02 23:05:57','Logged in'),
(506,3,'2025-04-02 23:10:23','Logged in'),
(507,3,'2025-04-02 23:47:51','Logged in'),
(508,3,'2025-04-02 23:48:05','Logged out'),
(509,3,'2025-04-02 23:53:18','Logged in'),
(510,3,'2025-04-02 23:59:56','Logged out'),
(511,3,'2025-04-03 00:03:13','Logged in'),
(512,3,'2025-04-03 00:05:28','Logged out'),
(513,3,'2025-04-14 09:53:33','Logged in'),
(514,3,'2025-04-14 10:09:36','Logged out');
...
(27,27,1,'2025-04-02 23:56:29','Returned'),
(28,30,1,'2025-04-02 23:59:19','Returned'),
(29,31,1,'2025-04-14 09:54:44','Returned');
